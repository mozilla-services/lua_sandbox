...
local function single_line_logevent()
    ...
    local single_line_test_fields = {
        ...
        ErrorClass   = "com.domain.client.jobs.OutgoingQueue",
    ...
    assert(fields.ErrorClass == single_line_test_fields.ErrorClass, fields.ErrorClass)
...
! java.net.SocketTimeoutException: Read timed out
    ...
    local two_line_test_fields = {
        ...
        ErrorClass   = "com.domain.substitute.UsersLoop",
        ErrorMessage = "Error caught in user loop",
    ...
    assert(fields.ErrorClass == two_line_test_fields.ErrorClass, fields.ErrorClass)
    assert(fields.ErrorMessage == two_line_test_fields.ErrorMessage, fields.ErrorMessage)
    assert(fields.ExceptionClass == two_line_test_fields.ExceptionClass, fields.ExceptionClass)
    assert(fields.ExceptionMessage == two_line_test_fields.ExceptionMessage, fields.ExceptionMessage)
end
