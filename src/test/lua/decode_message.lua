...
local msg = assert(decode_message(test))
...
msg = assert(decode_message(test))
...
msg, err = decode_message(test)
assert(not msg)
assert(err == "invalid message, too short", err)

-- no uuid
test = "\016\128\148\235\220\003\082\023\010\005names\016\001\042\002s1\042\002s2\026\004keys"
msg, err = decode_message(test)
assert(not msg)
assert(err == "missing required field uuid: not found timestamp: found", err)
...
msg, err = decode_message(test)
assert(not msg)
assert(err == "missing required field uuid: found timestamp: not found", err)
...
msg, err = decode_message(test)
assert(not msg)
assert(err == "error in tag: 10 wiretype: 2 offset: 24", err)

-- random string
test = "this is a test item over twenty bytes long"
msg, err = decode_message(test)
assert(not msg)
assert(err == "error in tag: 14 wiretype: 4 offset: 0", err)
...
msg, err = decode_message(test)
assert(not msg)
assert(err == "error in tag: 2 wiretype: 0 offset: 18", err)
...
msg, err = decode_message(test)
assert(not msg)
assert(err == "error in tag: 3 wiretype: 2 offset: 24", err)
