...
local apache_format_arguments = {
   ...
   , i = function(a) return "http_" .. string.gsub(string.lower(a), "-", "_") end -- make it compatible with the Nginx naming covention
   , n = function(a) return "module_" .. a end
   , o = function(a) return "sent_http_" .. string.gsub(string.lower(a), "-", "_") end -- make it compatible with the Nginx naming covention
   , p = port_format
   , P = pid_format
   , t = time_format
}
